...
describe('Customer Jobs logic helpers', () => {
  ...
  test('getActionText returns correct hints based on status and interest count', () => {
    ...
    expect(getActionText('open', 2)).toBe('Tap to view interested tradespeople');
    expect(getActionText('pending_customer_choice', 1)).toBe('Tap to view interested tradespeople');
