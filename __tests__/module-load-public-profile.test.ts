describe('Module load: app/public-profile', () => {
  test('require the module safely and check formatters', () => {
    try {
      ...
      expect(typeof mod.formatDate === 'function' || typeof mod.formatDate === 'undefined').toBeTruthy();
      expect(typeof mod.formatMemberSince === 'function' || typeof mod.formatMemberSince === 'undefined').toBeTruthy();
    } catch (err) {
      ...
      console.warn('module-load-public-profile: import failed, skipping assertions', err && err.message);
