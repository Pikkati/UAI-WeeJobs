...
export default function ReviewCustomerScreen() {
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      Alert.alert(
        'Review Submitted!',
        'Thanks for rating your customer.',
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + Spacing.md }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Your honest review helps other tradies know what to expect and rewards great customers.
          </Text>
        </View>
      ...
      <View style={[styles.footer, { paddingBottom: insets.bottom + Spacing.md }]}>
        ...
        <TouchableOpacity style={styles.skipButton} onPress={() => router.push('/tradie')}>
