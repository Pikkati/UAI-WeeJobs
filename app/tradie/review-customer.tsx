...
export default function ReviewCustomerScreen() {
  ...
  const handleSubmitReview = async () => {
    ...
    try {
      ...
      Alert.alert('Review Submitted!', 'Thanks for rating your customer.', [
    ...
    <View style={[styles.container, { paddingTop: insets.top + Spacing.md }]}>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.ratingSection}>
          <Text style={styles.sectionTitle}>How was this customer?</Text>
        ...
        <View style={styles.commentSection}>
          ...
          <TextInput
            ...
            placeholder="Were they easy to work with? Any notes for other tradies..."
        ...
        <View style={styles.tipCard}>
          ...
          <Text style={styles.tipText}>
            Your honest review helps other tradies know what to expect and
            rewards great customers.
          </Text>
        </View>
