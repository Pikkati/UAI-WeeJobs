...
try {
  if (typeof globalThis !== 'undefined') {
    globalThis.__EXPO_ROUTER_INSPECTOR_VERY_EARLY = {
      ts: Date.now(),
      source: '_routesManifest-top',
    } as const;
  }
  if (typeof console !== 'undefined') {
    if (typeof console.error === 'function') {
      console.error(
        '[expo-router-inspector-very-early] _routesManifest-top initialized',
...
globalThis.__EXPO_ROUTER_MODULES = {
  ...
  './onboarding/reset-password.tsx': () =>
    require('./onboarding/reset-password.tsx'),
...
try {
  if (
    ...
    Array.isArray(globalThis.__EXPO_ROUTER_KEYS)
  ) {
    // eslint-disable-next-line no-console
    console.log(
      '[routes-manifest] __EXPO_ROUTER_KEYS length=',
