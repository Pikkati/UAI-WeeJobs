...
"""
  ...
  """
    ...
    // The exact indentation and blank lines can vary across platforms; assert the important
    // tokens are present in the generated header instead of requiring byte-for-byte equality.
    assertThat(declareFile.readText()).contains("GFLAGS_NAMESPACE gflags")
    ...
    // Allow either with or without a leading newline across platforms
    assertEquals(gflagsFile.readText().trim(), "#include \"gflags/gflags_google.h\"")
